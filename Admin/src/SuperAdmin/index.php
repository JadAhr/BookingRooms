...
<table class="mx-auto w-3/4 border-collapse bg-white border border-gray-400">
    <thead>
        <tr class="bg-gray-300 text-gray-700 uppercase text-sm leading-normal">
            <th class="py-3 px-6 text-left">CodeUser</th>
    ...
    <tbody class="text-gray-600 text-sm font-light">
        ...
        <form action="../php/bookings.php" method="POST">
          <input hidden  type="text" name="ccl" value = '<?php echo htmlspecialchars($donnees['codeClient']); ?>'>
            <td class="py-3 px-6 text-left whitespace-nowrap" style="font-family: Poppins, sans-serif"><?php echo htmlspecialchars($donnees['codeClient']); ?></td>
            ...
            <td class=" space-x-2 flex justify-center items-center">
                <form action="./edite" method="get">
                    <input hidden name="codeinscrir" value="<?php echo $donnees['codeClient']; ?>">
                    <button type="submit"><i class="fa-solid fa-pen-to-square text-blue-500"></i></button>
                </form>
                <form action="./DeletClient.php" method="get">
                    <input hidden name="codecl" value="<?php echo $donnees['codeClient']; ?>">
                    <button type="submit"><i class="fa-solid fa-x text-red-700" style=";"></i></button>
                </form> 
            </td>
